let find,filter,sortBy,fs,collection;_640‍.w("lodash/find",[["default",["find"],function(v){find=v}]]);_640‍.w("lodash/filter",[["default",["filter"],function(v){filter=v}]]);_640‍.w("lodash/sortBy",[["default",["sortBy"],function(v){sortBy=v}]]);_640‍.w("fs",[["default",["fs"],function(v){fs=v}]]);_640‍.w("d3-collection",[["*",null,function(v){collection=v}]]);
...
async function main() {
  ...
  _640‍.g.console.log(JSON.stringify(mappedData))
}
main()
